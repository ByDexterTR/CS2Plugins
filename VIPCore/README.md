...
| `RapidFire` | `firepercent` is the fire rate (`0.1` – `2.0`): `1.0` normal, `2.0` fastest, below that is slower. `recoilpercent` is the recoil left (`0.0` – `1.0`): `0.0` none, `1.0` normal. `only_stance` picks when it works: `0` always, `1` while walking, `2` while crouching, `3` while jumping, `4` while standing still; the digits can be combined (`13` = walking or jumping) | `{ "only_with_weapon": "", "only_stance": 0, "recoilpercent": 0.0, "firepercent": 2.0 }` |
