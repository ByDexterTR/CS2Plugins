...
internal static unsafe class NativeTrace
{
    ...
    private static bool EnsureInit()
    {
        ...
        try
        {
            ...
            Console.WriteLine("[Cit] Native trace hazir (CNavPhysicsInterface).");
            return true;
        }
        catch (Exception ex)
        {
            ...
            Console.WriteLine($"[Cit] HATA: Trace baslatilamadi: {ex.Message}");
            return false;
        }
    }
    ...
    public static System.Numerics.Vector3? TraceFromEyes(CCSPlayerPawn pawn, ulong mask = MaskShotPhysics)
    {
        ...
        *trace = default;
        ...
        _traceShape!(IntPtr.Zero, ray, eye.Handle, end.Handle, filter, trace);
