...
| Eklenti | Açıklama | Kategori | Gereksinim |
| --- | --- | --- | --- |
...
| [CTKov](CTKov/README.tr.md) | Warden olmayan tüm CT'leri tek komutla T'ye taşır | Jailbreak | CounterStrikeSharp |
| [CTPerk](CTPerk/README.tr.md) | T sayısına göre hak tanınan raunt bazlı CT güçlendirmeleri | Jailbreak | CounterStrikeSharp |
| [CTRev](CTRev/README.tr.md) | Ölen CT'leri menüden/otomatik canlandırma | Jailbreak | CounterStrikeSharp |
...
| [Postprocessing](Postprocessing/README.tr.md) | Oyuncuya özel post processing efekti; 106 hazır efekt (bloom, blur, renk, zoom) | Genel | CounterStrikeSharp |
| [PrivateMessage](PrivateMessage/README.tr.md) | Oyuncular arası özel mesaj (!pm) | Genel | CounterStrikeSharp, MySQL (opsiyonel) |
...
Kullanıma hazır dosyalar `.Compiled` klasöründe; ayrıca derlemenize gerek yok.

1. **Hepsini kurmak için:** `.Compiled/addons` klasörünün içeriğini sunucudaki `csgo/addons` klasörüne kopyalayın.
2. **Sadece bir eklenti kurmak için:** `.Compiled/addons/counterstrikesharp/plugins/` altından o eklentinin klasörünü alıp sunucudaki aynı yere koyun.
3. Sunucuyu yeniden başlatın veya `css_plugins load <EklentiAdı>` komutunu çalıştırın.
4. Ayar dosyaları ilk açılışta kendiliğinden oluşur. Eklentiye özel ayarlar için ilgili eklentinin README dosyasına bakın.
